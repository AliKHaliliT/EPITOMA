...
2. **One-line pitch**, then a short expansion. The expansion carries the attribution: one sentence linking the house style ([My-Styles](https://github.com/AliKHaliliT/My-Styles)) and naming the template commit this project was last aligned to. It is required because the inherited conventions and decision records are unintelligible without their provenance, and the commit is what a later re-alignment starts from.
