# 0007. Name the design tokens semantically in two layers
...
say what they are for. The palette presets in src/shared/lib/palette.ts and the
...
src/shared/lib/palette.ts now carries the mapping between the two. That indirection
