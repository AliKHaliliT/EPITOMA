...
Status: Superseded by [0008](0008-adopt-the-client-styles-documentation-system.md)
Date: 2026-07-28

## Context

EPITOMA was extracted from the VITA repository into its own standalone app (VITA's decision
