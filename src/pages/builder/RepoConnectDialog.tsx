...
const RepoForm = ({ repoRef, onConnect, onDisconnect, onClose }: Omit<RepoDialogProps, "open">) => {
  ...
  return (
    ...
    >
            ...
            {error && (
              <p role="alert" className="m-0 mt-3 rounded-lg border border-danger bg-danger px-3 py-2 text-sm text-danger dark:border-danger dark:bg-danger/20 dark:text-danger">
                {error}
              </p>
            )}
