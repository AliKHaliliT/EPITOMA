...
import { PAGE_DIMS, ResumeDocument, ResumeEntry, ResumeSection, ResumeStyle, fmtResumeDate, presentWord, proficiencyDots, resolveColors, resolveEntry, resolveGeometry, resolveHeading, resolveType, sectionShape, splitRegions, type ColorPlan, type HeadingSpec, type TypeScale } from "@/entities/resume";
